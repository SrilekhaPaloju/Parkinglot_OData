		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Parking App",
									"targetURL": "#comappparkingapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappparkingapplication-display": {
								"semanticObject": "comappparkingapplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.parkingapplication",
									"url": sap.ui.require.toUrl("com/app/parkingapplication")
								}
							}
						}
					}
